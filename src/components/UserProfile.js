                  ...
                  <>
                    <div className="w-full lg:w-1/5 bg-white p-4">
                      <div className="bg-[#F5F5F5] mt-20">
                        ...
                        <h3 className="px-4 py-2">Employee:{userinfo[0]?.username}</h3>
                        <h3 className="px-4 py-2">Employee id:{userinfo[0]?.user_id}</h3>
                        <h3 className="px-4 py-2">Email:{userinfo[0]?.email}</h3>
                        <h3 className="px-4 py-2">Status:{userinfo[0]?.status == 1 ? "active" : "unactive"}</h3>
                        <h3 className="px-4 py-2">Project:{userinfo[0]?.project}</h3>
                      </div>
                    </div>
                          ...
                          <table className="min-w-full">
                            <thead>
                              <tr>
                                ...
                                <th className="px-6 py-3 bg-[#E3F2FD] text-left">
                                  Update{" "}
                                  <input  type="checkbox" className="form-checkbox m-2 h-4 w-4 text-indigo-600" />
                                </th>
                                <th className="px-6 py-3 bg-[#E3F2FD] text-left">
                                  Delete{" "}
                                  <input  type="checkbox" className="form-checkbox m-2 h-4 w-4 text-indigo-600" />
